...
function expandMetaType(type, metaObject) {
  var validType = typeof type === 'string' ? (0, _cellTypes.getCellType)(type) : type;
  ...
  (0, _object.objectEach)(validType, function (value, property) {
    if (!preventSourceOverwrite || preventSourceOverwrite && !(0, _object.hasOwnProperty)(metaObject, property)) {
